...
Locked by `scripts/test/event-identity.test.ts` (Brice 18:00 vs 19:00, Live Music @ X vs named act, two named acts stay split, 2-hour drift stays split) + `dedupe-events.test.ts` + `null-guard.test.ts`.
