...
const EVENTS_URL = "https://www.theluberoom.com/new-events";
const SOURCE_NAME = "The Lube Room Saloon";
const ORG_SLUG = "lube-room";

export async function scrapeLubeRoom(): Promise<void> {
  console.log("=== Lube Room Saloon Scraper ===");
