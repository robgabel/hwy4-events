...
const EVENTS_URL = "https://murphyswateringhole.com/";
const SOURCE_NAME = "The Watering Hole";
const ORG_SLUG = "watering-hole";

export async function scrapeWateringHole(): Promise<void> {
  console.log("=== The Watering Hole Scraper ===");
