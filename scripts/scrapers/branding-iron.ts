...
const EVENTS_URL = "https://murphysbrandingironsaloon.com/";
const SOURCE_NAME = "Branding Iron Saloon";
const ORG_SLUG = "branding-iron";

export async function scrapeBrandingIron(): Promise<void> {
  console.log("=== Branding Iron Saloon Scraper ===");
