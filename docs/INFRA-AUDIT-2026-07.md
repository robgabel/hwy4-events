...
7. **Model refresh pass.** **Ids bumped 2026-09-22** in `lib/agent/models.ts` (Opus 5.5 for voice copy, Sonnet 5 for reasoners and extraction, Haiku 4.5 unchanged). Still open: A/B the daily briefing on a Sonnet-class model for a week; the voice constitution does the heavy lifting, and the briefing is the single largest recurring Opus line.
