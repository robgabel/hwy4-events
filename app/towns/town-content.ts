...
export const TOWN_CONTENT: Record<string, TownContent> = {
  ...
  "arnold": {
    ...
    "intro": [
      ...
      "What it does have, more than anywhere else on the corridor: real businesses run by people who live here. Nate and Bonnie Randall's Hinterhaus Distilling took Best American Single Cask Single Malt at the 2026 World Whiskies Awards for their Singularity whiskey, after a country win for their North Grove Vodka at the 2024 World Vodka Awards. Posterity Ciderworks opened a second tasting room in town in 2026, with ciders that show up on Michelin restaurant lists. Connor Davis runs Heart & Soul Country Kitchen for breakfast and lunch Thursday through Monday. Larry Geiger has been running Bistro Espresso since 2005, and it functions as the de facto town square.",
    ...
    "personaNotes": [
      "If you're renting out a place to weekenders: send guests to Hinterhaus for cocktails (ask for the three-mini-cocktail flight if it's not a busy weekend), Sarafina's or Kalamata for dinner with a reservation, and Big Trees for the morning hike. Two things to pass along about Hinterhaus so nobody drives over for nothing: no one under 21 is allowed inside, so it doesn't work for a group with kids along, and California caps a distillery tasting room at one drink per visitor, so plan it as a stop before dinner. Bottles to take home are the workaround. Hinterhaus and Posterity Ciderworks are the better local-tasting stops right now.",
    ...
    "worthKnowing": [
      ...
      "Hinterhaus Distilling (925 Hwy 4) and El Vaquero share the same building complex. You can taste spirits next door to a Mexican restaurant with a deck. That's a real Arnold sequence. The distillery side is 21 and over, so the kids in your group eat first.",
      ...
      "Sequoia Woods Country Club's restaurant and lounge are open to the public, not just members. Green fairways under huge pines. Patio for lunch in summer, cozy lounge in winter. If this spot gets overrun I'm pulling this tip.",
